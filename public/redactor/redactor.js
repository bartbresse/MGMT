...
{
	return { init: function(){ var button = this.button.add('advanced', 'Advanced');this.button.setAwesome('advanced', 'fa-tasks');this.button.addCallback(button, this.advanced.testButton);},
...
(function($){
	...
	var Redactor = function(element, options)
	{
		...
		this.opts = $.extend({
			...
			modal_image_edit: String() +
				...
				'</select>' +
				'</div>' +
				'<div id="redactor_modal_footer form-actions">' +
					'<a href="javascript:void(null);" id="redactor_image_delete_btn" class="btn btn-primary redactor_modal_btn">' + RLANG._delete + '</a>&nbsp;&nbsp;&nbsp;' +
					'<a href="javascript:void(null);" class="btn btn-primary redactor_modal_btn redactor_btn_modal_close">' + RLANG.cancel + '</a>' +
					'<input type="button" name="save" class="btn btn-primary redactor_modal_btn" id="redactorSaveBtn" value="' + RLANG.save + '" />' +
				'</div>',
			...
			modal_image: String() +
				...
				'</div>' +
				'</div>' +
				'<div id="redactor_modal_footer" class="form-actions">' +
					'<a href="javascript:void(null);" class="btn btn-primary redactor_modal_btn redactor_btn_modal_close">' + RLANG.cancel + '</a>' +
					'<input type="button" name="upload" class="btn btn-primary redactor_modal_btn" id="redactor_upload_btn" value="' + RLANG.insert + '" />' +
				'</div>',
			...
			modal_link: String() +
				...
				'<div id="redactor_modal_footer" class="form-actions">' +
					'<a href="javascript:void(null);" class="btn btn-primary redactor_modal_btn redactor_btn_modal_close">' + RLANG.cancel + '</a>' +
					'<input type="button" class="btn btn-primary redactor_modal_btn" id="redactor_insert_link_btn" value="' + RLANG.insert + '" />' +
				'</div>',
			...
			modal_table: String() +
				...
				'<div id="redactor_modal_footer" class="form-actions">' +
					'<a href="javascript:void(null);" class="btn btn-primary redactor_modal_btn redactor_btn_modal_close">' + RLANG.cancel + '</a>' +
					'<input type="button" name="upload" class="btn btn-primary redactor_modal_btn" id="redactor_insert_table_btn" value="' + RLANG.insert + '" />' +
				'</div>',
			...
			modal_video: String() +
				...
				'<div id="redactor_modal_footer" class="form-actions">' +
					'<a href="javascript:void(null);" class="btn btn-primary redactor_modal_btn redactor_btn_modal_close">' + RLANG.cancel + '</a>' +
					'<input type="button" class="btn btn-primary redactor_modal_btn" id="redactor_insert_video_btn" value="' + RLANG.insert + '" />' +
				'</div>',
	...
	Redactor.prototype = {
		...
		buildToolbar: function()
		{
			...
			this.$toolbar.append($('<li><a class="redactor_btn_video" onclick="emailtemplates();">Template</a></li>'));
