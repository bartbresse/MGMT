...
class Mandrill extends Component
{
    ...
    function http_request ($url, $fields = array(), $method = 'POST')
    {
		...
		// B 8/18/14	echo 'TARTAN CURL RESPONSE'.$response;
    ...
    /**
     * @link https://mandrillapp.com/api/docs/messages.html#method=send-info
     *
     * @return array|Exception
     */	
	function messages_info($messageid)
	{
		return $this->request('messages/info', array('id' => $messageid));
	}
}
