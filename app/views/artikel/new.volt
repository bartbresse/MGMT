...
<div class="wrap">
	<div class="content container">
		<div class="row">
		    <div class="col-md-12">
	<h2 class="page-title"><? if(isset($_GET['id'])){ echo 'Wijzig'; }else{echo 'Nieuw';} ?> <?=$lang->translate('artikel');?> <!--<small>Out of the box form</small>--></h2>
		    </div>
		</div>
		<div class="row">
		    <div class="col-md-7">
					...
					<div class="body">
						<div id="user-form" class="form-horizontal label-left" data-parsley-priority-enabled="false" novalidate="">
							...
							<fieldset>
								...
								<div class="control-group" id="prijsgroup">
									<label class="control-label" for="prijs"><?=$lang->translate("Prijs");?>*
										<ul id="prijserror" class="parsley-errors-list"></ul>
									</label>
									<div class="controls form-group">
										<div><?php echo $form->render("prijs"); ?></div>
									</div>
								</div>
								...
								<div class="control-group" id="fileid*group">							
									...
									<div class="controls control-group">
										...
										<?	//crop images settings
											$config = array('slot' => 0,'x' => 210,'y' => 210,'cx' => 200,'cy' => 200,'id' => 23,'thumb' => 'true','crop' => 'true');	?>
							...
							<div class="form-actions" class="pull-right">
								<button type="submit" onclick="save({filearray:filearray, class:'form-control',action:'<?=$this->url->get('artikel/add');?>',goto:'<?=$this->url->get('artikel/index');?>'});" class="btn btn-primary">Opslaan</button>
								<button type="submit" onclick="save({ class:'form-control',action:'<?=$this->url->get('artikel/add');?>',goto:'<?=$this->url->get('artikel/new');?>'});" class="btn btn-primary">Opslaan + Nieuw</button>
								<button type="button" onclick="go('<?=$this->url->get('artikel/index');?>');" class="btn btn-default">Cancel</button>
							</div>
						</div>
					</div>
				</section>
