<div class="wrap">
	<div class="content container">
		<div class="row">
		    <div class="col-md-12">
	<h2 class="page-title"><?=$lang->translate('Afbeelding aanpassen');?></h2>
		    </div>
		</div>
		<div class="row">
		    <div class="col-md-7">
...
<?/*							
						...
						*/?>
							<div class="control-group" id="cropgroup">
								<label class="control-label" for="crop">Afbeelding
									<ul id="croperror" class="parsley-errors-list"></ul>
								</label>
								<div class="controls form-group">
									<div><?php echo $form->render("file"); ?></div>
								</div>
							</div>
							...
							<div class="form-actions" class="pull-right">
								<button type="submit" onclick="save({class:'form-control',action:'<?=$this->url->get('media/add');?>',goto:'<?=$this->url->get('media/index');?>'});" class="btn btn-primary">Opslaan</button>
								<button type="button" onclick="go('<?=$this->url->get('media/index');?>');" class="btn btn-default">Cancel</button>
							</div>
						</div>
					</div>
				</section>
