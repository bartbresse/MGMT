...
<div class="wrap">
	 <div class="content container">
		    <div class="row">
		        <div class="col-md-12">
		            <h2 class="page-title">Reacties op berichten<small></small></h2>
		        </div>
		    </div>
		    <div class="row">
		        <div class="col-md-12">
		            <section class="widget" id="mgmt-table-container">
		                ...
		                <header>
							<? if(count($berichtreacties->items) > 39){ ?>
		                ...
		                <div class="body">
		               <? if(isset($berichtreacties->items) && count($berichtreacties->items) > 0){ ?>
		                    <table id="datatable-table" class="table table-striped">
								...
								<?
									if(count($berichtreacties) > 0){
										foreach($berichtreacties->items as $berichtreactie)
										{
										?><tr id="<?=$berichtreactie->id;?>"><?	
											...
											<td id="bewerken" style="width:100px;">
												...
												{ ?><a onclick="del('<?=$berichtreactie->id;?>','berichtreactie');"><i class="fa fa-trash-o"></i></a><?	} 
												*/ ?>
												<a href="<?php echo  $this->url->get("berichtreactie/view&id=".$berichtreactie->id);?>"><i class="fa fa-search"></i></a>
												<a href="<?php echo  $this->url->get('berichtreactie/edit&id='.$berichtreactie->id);?>"><i class="fa fa-edit"></i></a>
												<a onclick="del('<?=$berichtreactie->id;?>','berichtreactie');"><i class="fa fa-trash-o"></i></a>
