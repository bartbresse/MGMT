		    ...
		    <div class="row">
		        <div class="col-md-12">
		            <section class="widget" id="mgmt-table-container">
		                ...
		                <div class="body">
		               <? if(isset($userinfos->items) && count($userinfos->items) > 0){ ?>
		                    <table id="datatable-table" class="table table-striped">
		                        <thead class="table table-striped table-editable no-margin">
		            			   <tr>
									<?
									$cc = 0;
									foreach($userinfos->items[0] as $key => $value)
									{
								...
								<?
									if(count($userinfos) > 0){
										foreach($userinfos->items as $userinfo)
										{
										?><tr id="<?=$userinfo->id;?>"><?	
											...
											<td id="bewerken" style="width:100px;">
												...
												{ ?><a onclick="del('<?=$userinfo->id;?>','userinfo');"><i class="fa fa-trash-o"></i></a><?	} 
												*/ ?>
												<a href="<?php echo  $this->url->get("userinfo/view&id=".$userinfo->id);?>"><i class="fa fa-search"></i></a>
												<a href="<?php echo  $this->url->get('userinfo/edit&id='.$userinfo->id);?>"><i class="fa fa-edit"></i></a>
												<a onclick="del('<?=$userinfo->id;?>','userinfo');"><i class="fa fa-trash-o"></i></a>
