...
<div class="wrap">
	 <div class="content container">
		    <div class="row">
		        <div class="col-md-12">
		            <h2 class="page-title">Doelgroepen<small></small></h2>
		        </div>
		    </div>
		    <div class="row">
		        <div class="col-md-12">
		            <section class="widget" id="mgmt-table-container">
		                ...
		                <div class="body">
		               <? if(isset($doelgroeps->items) && count($doelgroeps->items) > 0){ ?>
		                    <table id="datatable-table" class="table table-striped">
								...
								<?
									if(count($doelgroeps) > 0){
										foreach($doelgroeps->items as $doelgroep)
										{
										?><tr id="<?=$doelgroep->id;?>"><?	
											foreach($columns as $column)
												{
											...
											<td id="bewerken" style="width:100px;">
												...
												{ ?><a onclick="del('<?=$doelgroep->id;?>','doelgroep');"><i class="fa fa-trash-o"></i></a><?	} 
												*/ ?>
												<a href="<?php echo  $this->url->get("doelgroep/view&id=".$doelgroep->id);?>"><i class="fa fa-search"></i></a>
												<a href="<?php echo  $this->url->get('doelgroep/edit&id='.$doelgroep->id);?>"><i class="fa fa-edit"></i></a>
												<a onclick="del('<?=$doelgroep->id;?>','doelgroep');"><i class="fa fa-trash-o"></i></a>
