...
<div class="wrap">
	 <div class="content container">
		    <div class="row">
		        <div class="col-md-12">
		            <h2 class="page-title">Partners<small></small></h2> 
		        </div>
		    </div>
		    <div class="row">
		        <div class="col-md-12">
		            <section class="widget" id="mgmt-table-container">
		                ...
		                <div class="body">
		               <? if(isset($sponsors->items) && count($sponsors->items) > 0){ ?>
									...
									if(count($sponsors) > 0){
										...
										?><tr id="<?=$sponsor->id;?>"><?	
											...
											<td id="bewerken" style="width:100px;">
												...
												{ ?><a onclick="del('<?=$sponsor->id;?>','sponsor');"><i class="fa fa-trash-o"></i></a><?	} 
												*/ ?>
												<a href="<?php echo  $this->url->get("sponsor/view&id=".$sponsor->id);?>"><i class="fa fa-search"></i></a>
												<a href="<?php echo  $this->url->get('sponsor/edit&id='.$sponsor->id);?>"><i class="fa fa-edit"></i></a>
												<a onclick="del('<?=$sponsor->id;?>','sponsor');"><i class="fa fa-trash-o"></i></a>
