...
<div class="wrap">
	 <div class="content container">
		    <div class="row">
		        <div class="col-md-12">
		            <h2 class="page-title">Workshops<small></small></h2>
		        </div>
		    </div>
		    <div class="row">
		        <div class="col-md-12">
		            <section class="widget" id="mgmt-table-container">
		                ...
		                <div class="body">
		               <? if(isset($workshops->items) && count($workshops->items) > 0){ ?>
		                    <table id="datatable-table" class="table table-striped">
								...
								<?
									if(count($workshops) > 0){
										foreach($workshops->items as $workshop)
										{
										?><tr id="<?=$workshop->id;?>"><?	
											foreach($columns as $column)
												{
											...
											<td id="bewerken" style="width:100px;">
												...
												{ ?><a onclick="del('<?=$workshop->id;?>','workshop');"><i class="fa fa-trash-o"></i></a><?	} 
												*/ ?>
												<a href="<?php echo  $this->url->get("workshop/view&id=".$workshop->id);?>"><i class="fa fa-search"></i></a>
												<a href="<?php echo  $this->url->get('workshop/edit&id='.$workshop->id);?>"><i class="fa fa-edit"></i></a>
												<a onclick="del('<?=$workshop->id;?>','workshop');"><i class="fa fa-trash-o"></i></a>
