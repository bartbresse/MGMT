		    ...
		    <div class="row">
		        <div class="col-md-12">
		            <section class="widget" id="mgmt-table-container">
		                ...
		                <div class="body">
		               <? if(isset($paginas->items) && count($paginas->items) > 0){ ?>
		                    <table id="datatable-table" class="table table-striped">
								...
								<?
									if(count($paginas) > 0){
										foreach($paginas->items as $pagina)
										{
										?><tr id="<?=$pagina->id;?>"><?	
											foreach($columns as $column)
											{
											...
											<td id="bewerken" style="width:100px;">
												...
												{ ?><a onclick="del('<?=$pagina->id;?>','pagina');"><i class="fa fa-trash-o"></i></a><?	} 
												*/ ?>
												<a href="<?php echo  $this->url->get("pagina/view&id=".$pagina->id);?>"><i class="fa fa-search"></i></a>
												<a href="<?php echo  $this->url->get('pagina/edit&id='.$pagina->id);?>"><i class="fa fa-edit"></i></a>
												<a onclick="del('<?=$pagina->id;?>','pagina');"><i class="fa fa-trash-o"></i></a>
